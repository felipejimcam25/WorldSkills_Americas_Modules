...
In Latin America, the trade of local food products plays an important economic and cultural role. Products such as **Brazilian coffee, Argentine yerba mate, Ecuadorian cocoa, Dominican vanilla, and Costa Rican Coffee** are part of the region’s identity.
...
2. Install dependencies ( Ncessary )
...
5. Access:
    - Admin panel: http://localhost:3000/admin/login
        - Username: admin
        - Password: 12345678
   - Public products page: http://localhost:3000/public/producto
