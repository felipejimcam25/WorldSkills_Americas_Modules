async function displayWeather() {
    ...
    <article class="weatherContent" id="list">
    ...
    data.forEach(weather => {
        ...
        div.innerHTML = `
            ...
            <div class="temp">
            <span>${weather.lower_temperature} - </span>
            <span>${weather.upper_temperature}*C</span>
            
            </div>
            <span>${weather.status}</span>
        `;

        const container = div.querySelector('.iconContainer');
        let icon = '';
        if(weather.status.toLowerCase() === 'rainy'){
            icon = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="800px" height="800px" viewBox="0 0 96 96" enable-background="new 0 0 96 96" xml:space="preserve">
...
<g id="Dibujo">
	<g>
        ...
        } else if(weather.status.toLowerCase() === 'sunny'){
            icon = `
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="800px" height="800px" viewBox="0 0 96 96" enable-background="new 0 0 96 96" xml:space="preserve">
<g id="Base" display="none">
</g>
<g id="Dibujo">
